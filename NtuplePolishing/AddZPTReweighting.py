        ...
        if(FileName != "Embedded.root"
           and FileName != "Data.root"):
            ...
            if(Trigger24 or Trigger27):
                ZPTWeighting[0] = ZPTWeighting[0] * SecondWorkSpace.function("m_trg24_27_kit_data").getVal()/SecondWorkSpace.function("m_trg24_27_kit_mc").getVal()
            else:
                ZPTWeighting[0] = ZPTWeighting[0] * (SecondWorkSpace.function("m_trg20_data").getVal()/SecondWorkSpace.function("m_trg20_mc").getVal())*TheTree.DiTauTriggerWeight
