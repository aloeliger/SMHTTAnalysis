...
def AddCrossSectionWeightings(FileToRun):
    ...
    for i in tqdm(range(ReweightFile.mt_tree.GetEntries())):
        ...
        if ("WW.root" in FileToRun):
            CrossSectionWeighting = LHCLumi * 118.7e-12 / TotalNumberOfEvents
        elif ("WZ.root" in FileToRun):
            CrossSectionWeighting = LHCLumi * 47.13e-12 / TotalNumberOfEvents
        elif("ZZ.root" in FileToRun):
            CrossSectionWeighting = LHCLumi * 16.523e-12 / TotalNumberOfEvents
            ...
            if(ReweightFile.mt_tree.numGenJets==0):
                CrossSectionWeighting = 110.1887
            elif(ReweightFile.mt_tree.numGenJets==1):
                CrossSectionWeighting = 14.1549
            elif(ReweightFile.mt_tree.numGenJets==2):
                CrossSectionWeighting = 7.43847
            elif(ReweightFile.mt_tree.numGenJets==3):
                CrossSectionWeighting = 2.40205
            elif(ReweightFile.mt_tree.numGenJets==4):
                CrossSectionWeighting = 2.14075
        elif("TTTo2L2Nu.root" in FileToRun):
            CrossSectionWeighting = LHCLumi * 88.34e-12 / TotalNumberOfEvents
        elif("TTToHadronic.root" in FileToRun):
            CrossSectionWeighting = LHCLumi * 377.96e-12 / TotalNumberOfEvents
        elif("TTToSemiLeptonic.root" in  FileToRun):
            CrossSectionWeighting = LHCLumi * 365.45e-12 / TotalNumberOfEvents
            ...
            if(ReweightFile.mt_tree.numGenJets==0):
                CrossSectionWeighting = 3.009
            elif(ReweightFile.mt_tree.numGenJets==1):
                CrossSectionWeighting = 0.589
            elif(ReweightFile.mt_tree.numGenJets==2):
                CrossSectionWeighting = 0.612
            elif(ReweightFile.mt_tree.numGenJets==3):
                CrossSectionWeighting = 0.767
            elif(ReweightFile.mt_tree.numGenJets==4):
                CrossSectionWeighting = 0.690
