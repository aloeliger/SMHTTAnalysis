...
def GenerateRolledPlots(File,args):
    ...
    for i in tqdm(range(TheTree.GetEntries())):
        ...
        if TheTree.njets == 0:
            ZeroJetResultsRolled.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheWeight)
            #Handle Uncertainties
            if args.UseFakeFactor:
                ZeroJet_ff_qcd_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_syst_up)
                ZeroJet_ff_qcd_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_syst_down)
                ZeroJet_ff_qcd_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_up)
                ZeroJet_ff_qcd_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_down)
                ZeroJet_ff_qcd_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_up)
                ZeroJet_ff_qcd_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_down)
                ZeroJet_ff_tt_njet1_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_up)
                ZeroJet_ff_tt_njet1_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_down)
                ZeroJet_ff_tt_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_syst_up)
                ZeroJet_ff_tt_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_syst_down)
                ZeroJet_ff_w_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_up)
                ZeroJet_ff_w_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_down)
                ZeroJet_ff_w_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_up)
                ZeroJet_ff_w_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_down)
                ZeroJet_ff_w_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_syst_up)
                ZeroJet_ff_w_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_syst_down)
            if args.UseTES:                
                ...
                if(TheTree.l2_decayMode == 0):
                    ZeroJet_DM0_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)                    
                    ZeroJet_DM1_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM0_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    
                elif(TheTree.l2_decayMode == 1):
                    ZeroJet_DM0_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM1_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM1_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    
                elif(TheTree.l2_decayMode == 10):
                    ZeroJet_DM0_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM1_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    ZeroJet_DM10_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
        
        elif TheTree.njets == 1:
            BoostedResultsRolled.Fill((MuVector+TauVector).M(),(MuVector+TauVector).Pt(),TheWeight)
            #Handle Uncertainties
            if args.UseFakeFactor:
                Boosted_ff_qcd_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_syst_up)
                Boosted_ff_qcd_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_syst_down)
                Boosted_ff_qcd_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_up)
                Boosted_ff_qcd_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_down)
                Boosted_ff_qcd_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_up)
                Boosted_ff_qcd_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_down)
                Boosted_ff_tt_njet1_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_up)
                Boosted_ff_tt_njet1_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_down)
                Boosted_ff_tt_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_syst_up)
                Boosted_ff_tt_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_tt_syst_down)
                Boosted_ff_w_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_up)
                Boosted_ff_w_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_down)
                Boosted_ff_w_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_up)
                Boosted_ff_w_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_down)
                Boosted_ff_w_syst_UP.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_syst_up)
                Boosted_ff_w_syst_DOWN.Fill((MuVector+TauVector).M(),(TauVector+MuVector).Pt(),TheTree.FinalWeighting*TheTree.ff_w_syst_down)
            if args.UseTES:
                CorrectedTauVector_UP = ROOT.TLorentzVector()
                CorrectedTauVector_DOWN = ROOT.TLorentzVector()
                CorrectedTauVector_UP.SetPtEtaPhiM(TheTree.TES_Pt_UP,TheTree.eta_2,TheTree.phi_2,TheTree.m_2)
                CorrectedTauVector_DOWN.SetPtEtaPhiM(TheTree.TES_Pt_DOWN,TheTree.eta_2,TheTree.phi_2,TheTree.m_2)
                if(TheTree.l2_decayMode == 0):
                    Boosted_DM0_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM0_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    
                elif(TheTree.l2_decayMode == 1):
                    Boosted_DM0_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    
                elif(TheTree.l2_decayMode == 10):
                    Boosted_DM0_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_UP.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
                    Boosted_DM10_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),(TauVector+MuVector).Pt(),TheWeight)
            
        elif TheTree.njets == 2:
            VBFResultsRolled.Fill((MuVector+TauVector).M(),TheTree.mjj,TheWeight)
            #Handle Uncertainties
            if args.UseFakeFactor:
                VBF_ff_qcd_syst_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_syst_up)
                VBF_ff_qcd_syst_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_syst_down)
                VBF_ff_qcd_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_up)
                VBF_ff_qcd_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet0_stat_down)
                VBF_ff_qcd_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_up)
                VBF_ff_qcd_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_qcd_dm0_njet1_stat_down)
                VBF_ff_tt_njet1_stat_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_up)
                VBF_ff_tt_njet1_stat_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_tt_dm0_njet1_stat_down)
                VBF_ff_tt_syst_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_tt_syst_up)
                VBF_ff_tt_syst_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_tt_syst_down)
                VBF_ff_w_njet0_mt_stat_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_up)
                VBF_ff_w_njet0_mt_stat_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_dm0_njet0_stat_down)
                VBF_ff_w_njet1_mt_stat_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_up)
                VBF_ff_w_njet1_mt_stat_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_dm0_njet1_stat_down)
                VBF_ff_w_syst_UP.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_syst_up)
                VBF_ff_w_syst_DOWN.Fill((MuVector+TauVector).M(),TheTree.mjj,TheTree.FinalWeighting*TheTree.ff_w_syst_down)
            if args.UseTES:
                CorrectedTauVector_UP = ROOT.TLorentzVector()
                CorrectedTauVector_DOWN = ROOT.TLorentzVector()
                CorrectedTauVector_UP.SetPtEtaPhiM(TheTree.TES_Pt_UP,TheTree.eta_2,TheTree.phi_2,TheTree.m_2)
                CorrectedTauVector_DOWN.SetPtEtaPhiM(TheTree.TES_Pt_DOWN,TheTree.eta_2,TheTree.phi_2,TheTree.m_2)
                if(TheTree.l2_decayMode == 0):
                    VBF_DM0_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM0_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    
                elif(TheTree.l2_decayMode == 1):
                    VBF_DM0_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    
                elif(TheTree.l2_decayMode == 10):
                    VBF_DM0_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_UP.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_UP.Fill((CorrectedTauVector_UP+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM0_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM1_TES_DOWN.Fill((TauVector+MuVector).M(),TheTree.mjj,TheWeight)
                    VBF_DM10_TES_DOWN.Fill((CorrectedTauVector_DOWN+MuVector).M(),TheTree.mjj,TheWeight)
