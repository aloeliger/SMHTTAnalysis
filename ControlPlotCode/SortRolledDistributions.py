...
ZeroJet_Higgs_Upscale.SetLineColor(ROOT.kCyan-6)
...
Boosted_Higgs_Upscale.SetLineColor(ROOT.kCyan-6)
...
VBF_Higgs_Upscale.SetLineColor(ROOT.kCyan-6)
...
ZeroJetLegend = ROOT.TLegend(0.9,0.6,1.0,0.9)
...
ZeroJetLegend.AddEntry(ZeroJet_Higgs_Upscale,"All Higgs (x30)","l")
...
BoostedLegend.AddEntry(Boosted_Higgs_Upscale,"All Higgs (x30)","l")
