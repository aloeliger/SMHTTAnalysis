...
ZeroJet_data_obs_Rolled = TheFile.mt_0jet.Get("data_obs_0jet_mvis_Rolled")

ZeroJet_Fakes_Rolled = TheFile.mt_0jet.Get("data_obs_0jet_Fake_mvis_Rolled")

ZeroJet_ZTauTau_Rolled = TheFile.mt_0jet.Get("embedded_0jet_mvis_Rolled")

ZeroJet_ZToLeptons_Rolled = TheFile.mt_0jet.Get("DY_0jet_mvis_Rolled")
ZeroJet_ZToLeptons_Rolled.Add(TheFile.mt_0jet.Get("DYlow_0jet_mvis_Rolled"))

ZeroJet_TT_Rolled = TheFile.mt_0jet.Get("TTToHadronic_0jet_mvis_Rolled")
ZeroJet_TT_Rolled.Add(TheFile.mt_0jet.Get("TTTo2L2Nu_0jet_mvis_Rolled"))
ZeroJet_TT_Rolled.Add(TheFile.mt_0jet.Get("TTToSemiLeptonic_0jet_mvis_Rolled"))

ZeroJet_Diboson_Rolled = TheFile.mt_0jet.Get("WW4Q_0jet_mvis_Rolled")
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("WWLNuQQ_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("WZ2L2Q_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("WZ1L3Nu_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("WZ3LNu_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("WZ1L1Nu2Q_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("ZZ4L_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("ZZ2L2Nu_0jet_mvis_Rolled"))
ZeroJet_Diboson_Rolled.Add(TheFile.mt_0jet.Get("ZZ2L2Q_0jet_mvis_Rolled"))

ZeroJet_SingleTop_Rolled = TheFile.mt_0jet.Get("ST_t_antitop_0jet_mvis_Rolled")
ZeroJet_SingleTop_Rolled.Add(TheFile.mt_0jet.Get("ST_t_top_0jet_mvis_Rolled"))
ZeroJet_SingleTop_Rolled.Add(TheFile.mt_0jet.Get("ST_tW_antitop_0jet_mvis_Rolled"))
ZeroJet_SingleTop_Rolled.Add(TheFile.mt_0jet.Get("ST_tW_top_0jet_mvis_Rolled"))
#Temporary?
ZeroJet_Diboson_Rolled.Add(ZeroJet_SingleTop_Rolled)

ZeroJet_ggH_htt_Rolled = TheFile.mt_0jet.Get("ggH_htt125_0jet_mvis_Rolled")

ZeroJet_qqH_htt_Rolled = TheFile.mt_0jet.Get("qqH_htt125_0jet_mvis_Rolled")

ZeroJet_WH_htt_Rolled = TheFile.mt_0jet.Get("WplusH125_0jet_mvis_Rolled")
ZeroJet_WH_htt_Rolled.Add(TheFile.mt_0jet.Get("WminusH125_0jet_mvis_Rolled"))

ZeroJet_ZH_htt_Rolled = TheFile.mt_0jet.Get("ZH125_0jet_mvis_Rolled")

ZeroJet_EWK_Rolled = TheFile.mt_0jet.Get("EWKZLL_0jet_mvis_Rolled")
ZeroJet_EWK_Rolled.Add(TheFile.mt_0jet.Get("EWKZNuNu_0jet_mvis_Rolled"))

#Boosted
Boosted_data_obs_Rolled = TheFile.mt_boosted.Get("data_obs_boosted_mvis_Rolled")

Boosted_Fakes_Rolled = TheFile.mt_boosted.Get("data_obs_boosted_Fake_mvis_Rolled")

Boosted_ZTauTau_Rolled = TheFile.mt_boosted.Get("embedded_boosted_mvis_Rolled")

Boosted_ZToLeptons_Rolled = TheFile.mt_boosted.Get("DY_boosted_mvis_Rolled")
Boosted_ZToLeptons_Rolled.Add(TheFile.mt_boosted.Get("DYlow_boosted_mvis_Rolled"))

Boosted_TT_Rolled = TheFile.mt_boosted.Get("TTToHadronic_boosted_mvis_Rolled")
Boosted_TT_Rolled.Add(TheFile.mt_boosted.Get("TTTo2L2Nu_boosted_mvis_Rolled"))
Boosted_TT_Rolled.Add(TheFile.mt_boosted.Get("TTToSemiLeptonic_boosted_mvis_Rolled"))

Boosted_Diboson_Rolled = TheFile.mt_boosted.Get("WW4Q_boosted_mvis_Rolled")
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("WWLNuQQ_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("WZ2L2Q_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("WZ1L3Nu_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("WZ3LNu_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("WZ1L1Nu2Q_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("ZZ4L_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("ZZ2L2Nu_boosted_mvis_Rolled"))
Boosted_Diboson_Rolled.Add(TheFile.mt_boosted.Get("ZZ2L2Q_boosted_mvis_Rolled"))

Boosted_SingleTop_Rolled = TheFile.mt_boosted.Get("ST_t_antitop_boosted_mvis_Rolled")
Boosted_SingleTop_Rolled.Add(TheFile.mt_boosted.Get("ST_t_top_boosted_mvis_Rolled"))
Boosted_SingleTop_Rolled.Add(TheFile.mt_boosted.Get("ST_tW_antitop_boosted_mvis_Rolled"))
Boosted_SingleTop_Rolled.Add(TheFile.mt_boosted.Get("ST_tW_top_boosted_mvis_Rolled"))
#Temporary?
Boosted_Diboson_Rolled.Add(Boosted_SingleTop_Rolled)

Boosted_ggH_htt_Rolled = TheFile.mt_boosted.Get("ggH_htt125_boosted_mvis_Rolled")

Boosted_qqH_htt_Rolled = TheFile.mt_boosted.Get("qqH_htt125_boosted_mvis_Rolled")

Boosted_WH_htt_Rolled = TheFile.mt_boosted.Get("WplusH125_boosted_mvis_Rolled")
Boosted_WH_htt_Rolled.Add(TheFile.mt_boosted.Get("WminusH125_boosted_mvis_Rolled"))

Boosted_ZH_htt_Rolled = TheFile.mt_boosted.Get("ZH125_boosted_mvis_Rolled")

Boosted_EWK_Rolled = TheFile.mt_boosted.Get("EWKZLL_boosted_mvis_Rolled")
Boosted_EWK_Rolled.Add(TheFile.mt_boosted.Get("EWKZNuNu_boosted_mvis_Rolled"))

#VBF
VBF_data_obs_Rolled = TheFile.mt_vbf.Get("data_obs_vbf_mvis_Rolled")

VBF_Fakes_Rolled = TheFile.mt_vbf.Get("data_obs_vbf_Fake_mvis_Rolled")

VBF_ZTauTau_Rolled = TheFile.mt_vbf.Get("embedded_vbf_mvis_Rolled")

VBF_ZToLeptons_Rolled = TheFile.mt_vbf.Get("DY_vbf_mvis_Rolled")
VBF_ZToLeptons_Rolled.Add(TheFile.mt_vbf.Get("DYlow_vbf_mvis_Rolled"))

VBF_TT_Rolled = TheFile.mt_vbf.Get("TTToHadronic_vbf_mvis_Rolled")
VBF_TT_Rolled.Add(TheFile.mt_vbf.Get("TTTo2L2Nu_vbf_mvis_Rolled"))
VBF_TT_Rolled.Add(TheFile.mt_vbf.Get("TTToSemiLeptonic_vbf_mvis_Rolled"))

VBF_Diboson_Rolled = TheFile.mt_vbf.Get("WW4Q_vbf_mvis_Rolled")
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("WWLNuQQ_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("WZ2L2Q_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("WZ1L3Nu_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("WZ3LNu_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("WZ1L1Nu2Q_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("ZZ4L_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("ZZ2L2Nu_vbf_mvis_Rolled"))
VBF_Diboson_Rolled.Add(TheFile.mt_vbf.Get("ZZ2L2Q_vbf_mvis_Rolled"))

VBF_SingleTop_Rolled = TheFile.mt_vbf.Get("ST_t_antitop_vbf_mvis_Rolled")
VBF_SingleTop_Rolled.Add(TheFile.mt_vbf.Get("ST_t_top_vbf_mvis_Rolled"))
VBF_SingleTop_Rolled.Add(TheFile.mt_vbf.Get("ST_tW_antitop_vbf_mvis_Rolled"))
VBF_SingleTop_Rolled.Add(TheFile.mt_vbf.Get("ST_tW_top_vbf_mvis_Rolled"))
#Temporary?
VBF_Diboson_Rolled.Add(VBF_SingleTop_Rolled)

VBF_ggH_htt_Rolled = TheFile.mt_vbf.Get("ggH_htt125_vbf_mvis_Rolled")

VBF_qqH_htt_Rolled = TheFile.mt_vbf.Get("qqH_htt125_vbf_mvis_Rolled")

VBF_WH_htt_Rolled = TheFile.mt_vbf.Get("WplusH125_vbf_mvis_Rolled")
VBF_WH_htt_Rolled.Add(TheFile.mt_vbf.Get("WminusH125_vbf_mvis_Rolled"))

VBF_ZH_htt_Rolled = TheFile.mt_vbf.Get("ZH125_vbf_mvis_Rolled")

VBF_EWK_Rolled = TheFile.mt_vbf.Get("EWKZLL_vbf_mvis_Rolled")
VBF_EWK_Rolled.Add(TheFile.mt_vbf.Get("EWKZNuNu_vbf_mvis_Rolled"))
...
ZeroJet_Fakes.SetFillColor(ROOT.kRed)

ZeroJet_ZTauTau.SetLineColor(ROOT.kBlack)
ZeroJet_ZTauTau.SetFillColor(ROOT.kYellow)

ZeroJet_ZToLeptons.SetLineColor(ROOT.kBlack)
ZeroJet_ZToLeptons.SetFillColor(ROOT.kBlue)

ZeroJet_TT.SetLineColor(ROOT.kBlack)
ZeroJet_TT.SetFillColor(ROOT.kViolet)
...
ZeroJetLegend = ROOT.TLegend(0.7,0.7,0.9,0.9)
...
Boosted_Fakes.SetFillColor(ROOT.kRed)

Boosted_ZTauTau.SetLineColor(ROOT.kBlack)
Boosted_ZTauTau.SetFillColor(ROOT.kYellow)

Boosted_ZToLeptons.SetLineColor(ROOT.kBlack)
Boosted_ZToLeptons.SetFillColor(ROOT.kBlue)

Boosted_TT.SetLineColor(ROOT.kBlack)
Boosted_TT.SetFillColor(ROOT.kViolet)
...
BoostedLegend = ROOT.TLegend(0.7,0.7,0.9,0.9)
...
VBF_Fakes.SetFillColor(ROOT.kRed)

VBF_ZTauTau.SetLineColor(ROOT.kBlack)
VBF_ZTauTau.SetFillColor(ROOT.kYellow)

VBF_ZToLeptons.SetLineColor(ROOT.kBlack)
VBF_ZToLeptons.SetFillColor(ROOT.kBlue)

VBF_TT.SetLineColor(ROOT.kBlack)
VBF_TT.SetFillColor(ROOT.kViolet)
...
VBFLegend = ROOT.TLegend(0.7,0.7,0.9,0.9)
