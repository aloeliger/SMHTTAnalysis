...
void Draw2016ControlPlots()
{
  ...
  TH1F* WW_MuPt = (TH1F*) HistoFile->Get("WW_2016_MuPt");
  TH1F* WZ_MuPt = (TH1F*) HistoFile->Get("WZ_2016_MuPt");
  TH1F* ZZ_MuPt = (TH1F*) HistoFile->Get("ZZ_2016_MuPt");
  ...
  TH1F* WW_MuEta = (TH1F*) HistoFile->Get("WW_2016_MuEta");
  TH1F* WZ_MuEta = (TH1F*) HistoFile->Get("WZ_2016_MuEta");
  TH1F* ZZ_MuEta = (TH1F*) HistoFile->Get("ZZ_2016_MuEta");
  ...
  TH1F* WW_TauPt = (TH1F*) HistoFile->Get("WW_2016_TauPt");
  TH1F* WZ_TauPt = (TH1F*) HistoFile->Get("WZ_2016_TauPt");
  TH1F* ZZ_TauPt = (TH1F*) HistoFile->Get("ZZ_2016_TauPt");
  ...
  TH1F* WW_TauEta = (TH1F*) HistoFile->Get("WW_2016_TauEta");
  TH1F* WZ_TauEta = (TH1F*) HistoFile->Get("WZ_2016_TauEta");
  TH1F* ZZ_TauEta = (TH1F*) HistoFile->Get("ZZ_2016_TauEta");
  ...
  TH1F* WW_MET = (TH1F*) HistoFile->Get("WW_2016_MET");
  TH1F* WZ_MET = (TH1F*) HistoFile->Get("WZ_2016_MET");
  TH1F* ZZ_MET = (TH1F*) HistoFile->Get("ZZ_2016_MET");
  ...
  TH1F* WW_METPhi = (TH1F*) HistoFile->Get("WW_2016_METPhi");
  TH1F* WZ_METPhi = (TH1F*) HistoFile->Get("WZ_2016_METPhi");
  TH1F* ZZ_METPhi = (TH1F*) HistoFile->Get("ZZ_2016_METPhi");
  ...
  TH1F* WW_mvis = (TH1F*) HistoFile->Get("WW_2016_mvis");
  TH1F* WZ_mvis = (TH1F*) HistoFile->Get("WZ_2016_mvis");
  TH1F* ZZ_mvis = (TH1F*) HistoFile->Get("ZZ_2016_mvis");
  ...
  TH1F* WW_Njets = (TH1F*) HistoFile->Get("WW_2016_Njets");
  TH1F* WZ_Njets = (TH1F*) HistoFile->Get("WZ_2016_Njets");
  TH1F* ZZ_Njets = (TH1F*) HistoFile->Get("ZZ_2016_Njets");
  ...
  TH1F* WW_HiggsPt = (TH1F*) HistoFile->Get("WW_2016_HiggsPt");
  TH1F* WZ_HiggsPt = (TH1F*) HistoFile->Get("WZ_2016_HiggsPt");
  TH1F* ZZ_HiggsPt = (TH1F*) HistoFile->Get("ZZ_2016_HiggsPt");
  ...
  TH1F* WW_mjj = (TH1F*) HistoFile->Get("WW_2016_mjj");
  TH1F* WZ_mjj = (TH1F*) HistoFile->Get("WZ_2016_mjj");
  TH1F* ZZ_mjj = (TH1F*) HistoFile->Get("ZZ_2016_mjj");
  ...
  TH1F* WW_trigger = (TH1F*) HistoFile->Get("WW_2016_trigger");
  TH1F* WZ_trigger = (TH1F*) HistoFile->Get("WZ_2016_trigger");
  TH1F* ZZ_trigger = (TH1F*) HistoFile->Get("ZZ_2016_trigger");
  ...
  // TH1F* WW1L1Nu2Q_msv = (TH1F*) HistoFile->Get("WW1L1Nu2Q_2016_msv");
  // TH1F* WZ1L1Nu2Q_msv = (TH1F*) HistoFile->Get("WZ1L1Nu2Q_2016_msv");
  // TH1F* WZ2L2Q_msv = (TH1F*) HistoFile->Get("WZ2L2Q_2016_msv");
  // TH1F* WZJLLLNu_msv = (TH1F*) HistoFile->Get("WZJLLLNu_2016_msv");
  // TH1F* ZZ2L2Q_msv = (TH1F*) HistoFile->Get("ZZ2L2Q_2016_msv");
  // TH1F* ZZ4L_msv = (TH1F*) HistoFile->Get("ZZ4L_2016_msv");
  TH1F* ST_tW_top_msv = (TH1F*) HistoFile->Get("ST_tW_top_2016_msv");
  TH1F* ggH_msv = (TH1F*) HistoFile->Get("ggH_2016_msv");
  TH1F* VBF_msv = (TH1F*) HistoFile->Get("VBF_2016_msv");
  TH1F* WHPlus_msv = (TH1F*) HistoFile->Get("WHPlus_2016_msv");
  TH1F* WHMinus_msv = (TH1F*) HistoFile->Get("WHMinus_2016_msv");
  TH1F* ZH_msv = (TH1F*) HistoFile->Get("ZH_2016_msv");  
  TH1F* WW_msv = (TH1F*) HistoFile->Get("WW_2016_msv");
  TH1F* WZ_msv = (TH1F*) HistoFile->Get("WZ_2016_msv");
  TH1F* ZZ_msv = (TH1F*) HistoFile->Get("ZZ_2016_msv");

  TH1F* VVFinal_msv = (TH1F*) WW_msv->Clone();
  // VVFinal_msv->Add(WZ1L1Nu2Q_msv);
  // VVFinal_msv->Add(WZ2L2Q_msv);
  // VVFinal_msv->Add(WZJLLLNu_msv);
  // VVFinal_msv->Add(ZZ2L2Q_msv);
  // VVFinal_msv->Add(ZZ4L_msv);
  ...
  TT_msv->SetLineColor(kBlack);
  TT_msv->SetFillColor(TColor::GetColor("#9999cc"));
  ...
  BackgroundStack_msv->Add(TT_msv,"hist");
  ...
  Legend_msv->AddEntry(TT_msv,"t#bar{t}","f");  
