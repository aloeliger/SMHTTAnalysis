...
def GenerateControlPlots(TheFile,OutFile,args):
    ...
    DRHisto = ROOT.TH1F(FullHistoName+"_DR",FullHistoName+"_DR",40,0,3.14)
    ...
    DRHisto_DYll = ROOT.TH1F(FullHistoName+"_genmatch_low_DR",FullHistoName+"_genmatch_low_DR",40,0,3.14)
    ...
    DRHisto_DYtt = ROOT.TH1F(FullHistoName+"_genmatch_tt_DR",FullHistoName+"_genmatch_tt_DR",40,0,3.14)
