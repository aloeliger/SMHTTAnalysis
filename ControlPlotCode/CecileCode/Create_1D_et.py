...
file=ROOT.TFile("smh_et_2D.root","r")
file1=ROOT.TFile("smh_et.root","recreate")


file.cd()
dirList = gDirectory.GetListOfKeys()
for k1 in dirList:
      if k1.GetName()=="et_vbf2" or k1.GetName()=="et_gg2jets" or k1.GetName()=="et_vh2jets" or k1.GetName()=="et_1jet":
         h1 = k1.ReadObj()
      ...
      if k1.GetName()=="et_0jet" or k1.GetName()=="et_boosted" or k1.GetName()=="et_vbf":
         h1 = k1.ReadObj()
         file1.mkdir(h1.GetName())
         h1.cd()
         dirList2 = gDirectory.GetListOfKeys()
