...
file=ROOT.TFile("smh_mt_2D.root","r")
file1=ROOT.TFile("smh_mt.root","recreate")


file.cd()
dirList = gDirectory.GetListOfKeys()
for k1 in dirList:
      if k1.GetName()=="mt_vbf2" or k1.GetName()=="mt_gg2jets" or k1.GetName()=="mt_vh2jets" or k1.GetName()=="mt_1jet":
         h1 = k1.ReadObj()
